...
from app.worker.page_map import build_page_map


def get_page_map_by_analysis_id(
    session: Session,
    analysis_id: int,
) -> dict:
    documents = list(
    ...
    return build_page_map(documents, page_texts_by_document_id)
