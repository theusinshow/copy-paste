...
from app.worker.ai_review import build_ai_review


def get_ai_review_by_analysis_id(
    session: Session,
    analysis_id: int,
) -> dict:
    documents = list(
    ...
    return build_ai_review(documents, page_texts_by_document_id)
