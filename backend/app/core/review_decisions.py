...
REVIEW_DECISION_LABELS = {
    REVIEW_DECISION_CONFIRMED: "Confirmada",
    REVIEW_DECISION_FALSE_POSITIVE: "Não procede",
    REVIEW_DECISION_FIXED: "Corrigido",
    REVIEW_DECISION_NOT_APPLICABLE: "Não aplicável",
    REVIEW_DECISION_NO_EVIDENCE: "Sem evidência",
}

REVIEW_STATUS_LABELS = {
    REVIEW_STATUS_ACTIVE: "Ativa",
    REVIEW_STATUS_DISMISSED: "Descartada",
    REVIEW_STATUS_INCONCLUSIVE: "Sem evidência",
